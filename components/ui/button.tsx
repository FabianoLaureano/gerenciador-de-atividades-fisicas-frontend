...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-md text-sm font-semibold whitespace-nowrap transition-all duration-200 outline-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-[#C5A065] text-black hover:bg-[#B8935A]",
        destructive:
          "bg-destructive text-white hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:bg-destructive/60 dark:focus-visible:ring-destructive/40",
        outline:
          "border border-white/10 bg-transparent shadow-xs hover:bg-white/5 hover:text-white text-muted-foreground",
        secondary:
          "bg-secondary/50 text-white hover:bg-secondary/80 border border-white/5",
        ghost:
          "hover:bg-white/5 hover:text-white text-muted-foreground",
        link: "text-[#C5A065] underline-offset-4 hover:underline",
      },
      size: {
